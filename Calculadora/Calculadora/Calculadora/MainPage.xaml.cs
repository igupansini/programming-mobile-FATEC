...
namespace Calculadora
{
    public partial class MainPage : ContentPage
    {
        ...
        private void OnInverterSinal(object sender, EventArgs e)
        {
            double x = double.Parse(resultadoLabel.Text) * (-1);
            resultadoLabel.Text = x.ToString();
        }

        private void OnVirgula(object sender, EventArgs e)
        {
            resultadoLabel.Text += ",";
        }
    }
